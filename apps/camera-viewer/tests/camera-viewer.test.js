...
assert.ok(/setTimeout\(startLivePreview, 150\)/.test(script), 'A fókusz stabilizálása után gyorsan induljon az egyetlen MJPEG stream.');
...
console.log('camera-viewer 0.3.17 focused MJPEG tests: PASS');
