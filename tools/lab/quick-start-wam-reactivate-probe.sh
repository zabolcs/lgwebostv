...
SAM_RUNNING="$("${SSH[@]}" "luna-send -t 1 -f -w 2000 luna://com.webos.applicationManager/running '{}'" 2>&1 || true)"
SAM_DEV_RUNNING="$("${SSH[@]}" "luna-send -t 1 -f -w 2000 luna://com.webos.applicationManager/dev/running '{}'" 2>&1 || true)"
