...
GUARD = ROOT / "tools/generated-tv-scripts/guard-v040-long-back-rollback.sh"
...
with tempfile.TemporaryDirectory() as tmp:
    ...
    ok = False
    for _ in range(50):
        result = run(ssh + ["grep -q 'guard v0.4.0 started' /tmp/hu.szabi.launcher-wake.log 2>/dev/null && ! test -e /tmp/hu.szabi.launcher.install-handoff && echo PASS || true"])
    ...
    print("KNOWN_GOOD_LONG_BACK_GUARD_DEPLOY=PASS", flush=True)
