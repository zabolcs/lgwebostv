...
class StaticTests(unittest.TestCase):
    ...
    def test_launcher_tv_navigation_and_whole_page_layout(self):
        ...
        self.assertIn("launcher-resume-glyph", source)
        self.assertIn("launcher-refresh-glyph", source)
        self.assertIn("Frissítés", source)
        ...
        self.assertIn("return sendWebhook(body)", app_source)
        self.assertIn("mode: 'no-cors'", app_source)
        self.assertIn("encodeConfigForNas", app_source)
        self.assertIn("decodeConfigFromNas", app_source)
        self.assertIn("__sl_mode", app_source)
